...
function casa_balam_render_custom_header() {
    ...
    <!-- Mobile Drawer Navigation (outside header to avoid stacking context clipping) -->
    <div id="cb-mobile-nav" class="cb-mobile-drawer" aria-hidden="true">
        ...
        <ul class="cb-mobile-menu">
            ...
            <li><a href="<?php echo esc_url( home_url( '/about-us/' ) ); ?>"><?php esc_html_e( 'Our Story', 'astra-child-casabalam' ); ?></a></li>
            <li><a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>"><?php esc_html_e( 'Contact', 'astra-child-casabalam' ); ?></a></li>
        </ul>
